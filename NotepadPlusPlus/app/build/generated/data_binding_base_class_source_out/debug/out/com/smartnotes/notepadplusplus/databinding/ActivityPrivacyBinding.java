...
public final class ActivityPrivacyBinding implements ViewBinding {
  ...
  private ActivityPrivacyBinding(@NonNull CoordinatorLayout rootView,
      @NonNull MaterialToolbar toolbar, @NonNull TextView tvContent) {
  ...
  public static ActivityPrivacyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPrivacyBinding((CoordinatorLayout) rootView, toolbar, tvContent);
    }
